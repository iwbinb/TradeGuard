/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false server/env.d.ts` (hash: 3dbd223569e427ae69dca9021116a930)
...
interface __BaseEnv_Env {
	...
	MODEL_NAME: string;
	MODEL_CHECK_RUN_ID: string;
	MODEL_CHECK_EXPIRES_AT: string;
	MAX_GAS_PRICE_WEI: string;
	AUTH: DurableObjectNamespace<import("./index").AuthSession>;
	RUNNERS: DurableObjectNamespace<import("./index").TradingRunner>;
	MODEL_CHECKS: DurableObjectNamespace<import("./index").ModelDiagnostics>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "AuthSession" | "TradingRunner" | "ModelDiagnostics";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "RPC_URL" | "INDEXER_URL" | "FACTORY_ADDRESS" | "EXECUTION_ENABLED" | "EXECUTION_OWNER_ALLOWLIST" | "EXECUTION_EXPIRES_AT" | "MODEL_CALL_LIMIT" | "MONITOR_SECONDS" | "MODEL_ENDPOINT" | "MODEL_NAME" | "MODEL_CHECK_RUN_ID" | "MODEL_CHECK_EXPIRES_AT" | "MAX_GAS_PRICE_WEI">> {}
}
