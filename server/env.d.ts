/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false server/env.d.ts` (hash: ac1df229e872b65f9fb71b0773b97e6e)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AuthSession" | "TradingRunner";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "RPC_URL" | "INDEXER_URL" | "FACTORY_ADDRESS" | "EXECUTION_ENABLED" | "MODEL_ENDPOINT" | "MODEL_NAME" | "MAX_GAS_PRICE_WEI">> {}
}
